    ...
    <div id="content">
      <h1>Register</h1>  
        <div id="form" style="margin: 0px 35%;text-align: center;background-color: darkturquoise; padding-top:40px">
            <form id="msform" method="POST"  enctype="multipart/form-data" action="login.php">
                    ...
                    <input id="submitregister" type="submit" name="submitregister" onclick="validateRegister()" value="Create Accout"/>
                </form>
